...
export default function Navigation() {
  ...
  return (
    <header className="bg-black h-screen py-10 pr-8 rounded-tr-2xl rounded-br-2xl w-[300px]">
      <nav>
