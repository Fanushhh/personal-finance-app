    ...
    <section className="flex justify-between gap-6 mb-6">
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          {showSort && (
            <div className="absolute flex min-[1001px]:hidden flex-col bg-white w-30 shadow-md rounded-md right-0 p-2 *:p-2">
              {sortOptions.map((sortOption, index) => {
                ...
                return (
                  <span
                    ...
                    className={`${
                      sort === sortOption ? "font-bold!" : ""
                    } border-b-1 border-(--beige-100)`}
                  >
                    {sortOption}
                  </span>
                );
        ...
        {shouldIncludeFilter && <div className="relative">
          ...
          {showFilter && (
            <div className="absolute flex min-[1001px]:hidden flex-col bg-white w-40 shadow-md rounded-md right-0 p-2 *:p-2">
              {filterOptions.map((filterOption, index) => {
                ...
                return (
                  <span
                    ...
                    className={`${
                      category === filterOption ? "font-bold!" : ""
                    }  cursor-pointer border-b-1 border-(--beige-100)`}
                  >
                    {filterOption === "" ? "All Transactions" : filterOption}
                  </span>
                );
              })}
            </div>
